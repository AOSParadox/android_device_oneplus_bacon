...
public class QmiPrimitiveTypes {
    ...
    public static class QmiArray<T extends BaseQmiItemType> extends BaseQmiItemType {
        ...
        public int getSize() {
            ...
            for (short i = (short) 0; i < this.mArrayLength; i += QmiPrimitiveTypes.SIZE_OF_BYTE) {
    ...
    public static class QmiByte extends BaseQmiItemType {
        ...
        public QmiByte(byte[] bArray) throws InvalidParameterException {
            if (bArray.length < QmiPrimitiveTypes.SIZE_OF_BYTE) {
        ...
        public int getSize() {
            return QmiPrimitiveTypes.SIZE_OF_BYTE;
        }

        public String toString() {
            Object[] objArr = new Object[QmiPrimitiveTypes.SIZE_OF_BYTE];
            objArr[0] = Byte.valueOf(this.mVal);
            return String.format("val=%d", objArr);
        }
    ...
    public static class QmiEnum extends BaseQmiItemType {
        ...
        public String toString() {
            Object[] objArr = new Object[QmiPrimitiveTypes.SIZE_OF_BYTE];
            objArr[0] = Short.valueOf(this.mVal);
            return String.format("val=%d", objArr);
        }
    }
    ...
    public static class QmiInteger extends BaseQmiItemType {
        ...
        public QmiInteger(byte[] bArray) throws InvalidParameterException {
            if (bArray.length < QmiPrimitiveTypes.SIZE_OF_INT) {
                throw new InvalidParameterException();
            }
        ...
        public int getSize() {
            return QmiPrimitiveTypes.SIZE_OF_INT;
        }

        public String toString() {
            Object[] objArr = new Object[QmiPrimitiveTypes.SIZE_OF_BYTE];
            objArr[0] = Integer.valueOf(this.mVal);
            return String.format("val=%d", objArr);
        }
    ...
    public static class QmiLong extends BaseQmiItemType {
        ...
        public QmiLong(byte[] bArray) throws InvalidParameterException {
            if (bArray.length < QmiPrimitiveTypes.SIZE_OF_LONG) {
                throw new InvalidParameterException();
            }
        ...
        public String toStringValue() {
            ...
            return new BigInteger(QmiPrimitiveTypes.SIZE_OF_BYTE, buf.array()).toString();
        }

        public int getSize() {
            return QmiPrimitiveTypes.SIZE_OF_LONG;
        }
    ...
    public static class QmiShort extends BaseQmiItemType {
        ...
        public QmiShort(byte[] bArray) throws InvalidParameterException {
            if (bArray.length < QmiPrimitiveTypes.SIZE_OF_SHORT) {
                throw new InvalidParameterException();
            }
        ...
        public int getSize() {
            return QmiPrimitiveTypes.SIZE_OF_SHORT;
        }
    ...
    public static class QmiString extends BaseQmiItemType {
        ...
        public byte[] toByteArray() {
            ByteBuffer buf = QmiBase.createByteBuffer(getSize());
            for (int i = 0; i < this.mVal.length(); i += LENGTH_SIZE) {
