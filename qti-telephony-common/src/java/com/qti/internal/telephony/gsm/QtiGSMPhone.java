package com.qti.internal.telephony.gsm;
...
public class QtiGSMPhone extends GSMPhone {
    private static final String LOG_TAG = "QtiGSMPhone";

    public QtiGSMPhone(Context context, CommandsInterface ci, PhoneNotifier notifier, int phoneId) {
