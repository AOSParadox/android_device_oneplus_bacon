 ...
 *           The package name we use if "camera.msm8974". Why not?
 */
void _ZN7android13SensorManagerC1Ev(void *sensorMgr)
{
    void *string;

    ALOGI("msm8974 camera interposition library: your camera should work in M now.");

    _ZN7android8String16C1EPKc(&string, "camera.msm8974");
